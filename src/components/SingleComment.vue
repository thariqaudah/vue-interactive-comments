    ...
    <div class="single-comment">
      ...
      <div class="comment-main">
        <div class="comment-header">
          ...
          <div class="action">
            <div v-if="ownership">
              <button class="btn btn-delete" @click="handleDelete(comment.id)">
...
export default {
  ...
  setup(props) {
    ...
    const handleDelete = async commentId => {
      ...
      if (commentId === props.parentCommentId) {
      ...
      await deleteDoc(
        doc(db, 'comments', props.parentCommentId, 'replies', commentId)
      );
      removeComment(props.parentCommentId, commentId);
    };
